    ...
    cards: [
      {
        no: '01',
        name: '有机反应机理库',
        desc: '18 个高中有机反应 3D 机理动画：断键成键时间轴、双钩/鱼钩推电子箭头、预测产物练习、通关印章。',
        href: '/teaching/chem_lab3.1.html',
      },
      {
        no: '02',
        name: '有机命名实验室',
        desc: '烷/烯/含氧/酯/芳香五大族 + 命名生成器：搭结构、拼名称、纠错三题型，画布生长式搭建，标准闯关 + 地狱挑战。',
    ...
    cards: [
      {
        no: '01',
        name: '造·化学',
        desc: '虚拟实验室：配制、中和滴定、中和热、粗盐提纯等原创实验任务，器皿自由摆放、三种移液精度、气泡沉淀现象层，星级评分 + 积分排行。',
        href: '/teaching/chem_lab6.1.html',
      },
    ],
  },
  {
    ...
    cards: [
      ...
      },
      {
        no: '02',
        name: '记忆回廊',
        desc: '一条可行走的三维回廊：十座记忆门由章节美图装点，门的朝向会跟随你的目光；页内复习与三阶闯关，尽头是记忆之光。',
        href: '/teaching/chem_lab2.4.html',
      },
    ],
  },
]
